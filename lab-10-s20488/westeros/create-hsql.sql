create table actor (id bigint generated by default as identity (start with 1), also_known_as varchar(255), biography varchar(255), birthday date, deathday date, name varchar(255), popularity float(53) not null, profile_path varchar(255), source_id bigint not null, primary key (id));
